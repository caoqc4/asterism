...
export const MEMORY_SURFACE_WRITE_ENTRYPOINTS: MemorySurfaceWriteEntrypoint[] = [
  ...
  {
    id: 'taskplane.writeback_structured_apply',
    owner: 'TaskService',
    kind: 'service_boundary',
    ipcChannels: [
      'taskplaneWriteback:apply',
    ],
    surfaces: ['structured_task_state', 'decision'],
    writePolicies: [
      'dedicated_evaluator',
      'decision_service',
    ],
    ...
    note: 'Confirmed Taskplane Write Intent plans can update structured task state or create Decisions only through main-process service ports and recovery guards.',
  },
  {
    id: 'taskplane.writeback_task_file_apply',
    owner: 'TaskService',
    kind: 'service_boundary',
    ipcChannels: [
      'taskplaneWriteback:apply',
    ...
    note: 'Confirmed Taskplane Write Intent task-file plans write ordinary task files through target-task validation and reserved memory path guards.',
  },
  {
    id: 'taskplane.writeback_source_apply',
    owner: 'TaskService',
    kind: 'service_boundary',
    ipcChannels: [
      'taskplaneWriteback:apply',
    ...
    note: 'Confirmed Taskplane Write Intent source-context plans preserve source routing and quality metadata instead of treating evidence as ordinary files.',
  },
  {
    ...
    surfaces: ['task_md', 'task_record', 'task_file'],
