...
describe('ai runtime invocation contract', () => {
  ...
  it('derives Agent API execution promotion readiness from structured service evidence', () => {
    ...
    expect(partial.summary).toContain('pilotDecisionBackendPlanBackend=agent_api');
    ...
    expect(partial.summary).toContain('pilotDecisionBackendPlanOutputContract=pilot_decision_summary');
    ...
    expect(partial.summary).toContain('pilotDecisionBackendChoiceEvidence=recorded');
    expect(partial.summary).toContain('pilotDecisionDurableStateMutationAllowed=no');
