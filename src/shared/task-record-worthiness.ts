...
const EXTERNAL_SIGNAL_PATTERN = /外部|邮件|日历|slack|github|linear|webhook|信号|source|external/i;
const DURABLE_STATE_CHANGE_PATTERN = /状态|范围|目标|进度|约束|风险|依赖|完成标准|验收|Task\.md|artifact|产物/i;
