...
export const PRODUCT_FEATURE_IMPACT_AUDIT: ProductFeatureImpactAuditItem[] = [
  ...
  },
  {
    ...
    evidence: [
      ...
      'Agent API decomposition promotion readiness now returns satisfied and missing requirement lists plus requirements=x/7, missingRequirements=..., and promotionMissingRequirements=... summary evidence, matching the execution promotion readiness style without opening the deferred path.',
  ...
  },
  {
    ...
    evidence: [
      ...
      'Scheduler/background Decision proposal plans now return satisfied and missing requirement lists plus requirements=x/3, missingRequirements=..., and proposalMissingRequirements=... summary evidence without opening Decision persistence, writeback dispatch, or scheduler triggers.',
  ...
  },
  {
    ...
    evidence: [
      ...
      'Runtime patch promotion readiness now returns satisfied and missing requirement lists plus requirements=x/8, missingRequirements=..., and promotionMissingRequirements=... summary evidence, matching the Agent API promotion readiness style without opening direct workspace writes.',
    ],
    gaps: [
  ...
  },
  {
    ...
    evidence: [
      ...
      'AgentAutomationReadiness now returns satisfied and missing requirement lists plus requirements=x/9, missingRequirements=..., and automationMissingRequirements=... summary evidence, so mature scheduled/event tasks can show that only scheduled_event_entrypoint remains missing.',
      ...
      'Scheduled/event trigger plans now expose runtimeStartSatisfiedRequirements and runtimeStartMissingRequirements plus runtimeStartRequirements=x/3 and runtimeStartMissingRequirements=... summary evidence for trigger_plan_ready, scheduler_trigger_service, and run_limit_count.',
      ...
      'RuntimeEventRecord now formats panel.scheduled_event_agent_triggered payloads into readable Task Dynamics detail with run id, run status, terminal Run evidence status, trigger evidence status, and Standing Approval policy id.',
