...
export const PRODUCT_FEATURE_IMPACT_AUDIT: ProductFeatureImpactAuditItem[] = [
  ...
  },
  {
    ...
    evidence: [
      ...
      'Agent API provider tool readiness summaries now expose selectedApiRuntime, providerConfigured, configuredProvider, providerOwnedMetadata, providerMetadataMatchesSelected, providerMetadataOwner, providerMetadataPackage, explicitToolDeclaration, explicitToolDeclarationSource, explicitToolDeclarationPackage, explicitToolDeclarationPackageMatchesMetadata, declaredToolCount, declaredWebSearchToolCount, and declaredWebSearchTools after trimming and case-insensitive deduplication, so settings and smokes can distinguish runtime selection, configured provider identity, provider configuration, matching provider-owned package declarations, matching tool-declaration package identity, and web/search-specific declarations from runtime-probe-only tool discovery without overstating duplicate tool evidence.',
