...
export const PRODUCT_FEATURE_IMPACT_AUDIT: ProductFeatureImpactAuditItem[] = [
  ...
  },
  {
    ...
    evidence: [
      ...
      'Operator-started scheduled/event Agent triggers now reuse the scheduler run-limit review policy when runtime-start is blocked by the daily Standing Approval cap, recording the same target-scoped approval-required Decision proposal instead of returning a silent blocked run.',
