...
export const PRODUCT_FEATURE_IMPACT_AUDIT: ProductFeatureImpactAuditItem[] = [
  ...
  },
  {
    ...
    gaps: [
      'Future background scheduler decisions can now enter the Task Dynamics approval queue only through an authorized proposal timeline event, but scheduler-origin Decision drafting remains deferred until a real non-panel producer emits panel.scheduler_decision_proposed with target-task and authorization evidence.',
    ],
    nextActions: [
      'Connect any future non-panel scheduler/runtime Decision producer by recording panel.scheduler_decision_proposed with planSchedulerDecisionProposalFromEvidence-ready evidence, then keep durable Decision creation behind the Task Dynamics TaskplaneWritebackApprovalItem confirmation and main-side writeback dispatch boundary.',
    ],
  },
  {
