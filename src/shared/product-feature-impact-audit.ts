...
export const PRODUCT_FEATURE_IMPACT_AUDIT: ProductFeatureImpactAuditItem[] = [
  ...
  },
  {
    ...
    evidence: [
      ...
      'Runtime patch promotion routing now normalizes workspace-relative path separators before duplicate checks and touched-file matching, so equivalent slash/backslash paths cannot satisfy duplicate-free evidence as separate files and can still match safely when the file identity is genuinely the same.',
