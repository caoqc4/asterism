...
export const PRODUCT_FEATURE_IMPACT_AUDIT: ProductFeatureImpactAuditItem[] = [
  ...
  },
  {
    ...
    evidence: [
      ...
      'SchedulerService.proposeSchedulerDecision now also requires a concrete title, rationale, at least one nonblank option, and a nonblank proposed outcome before recording panel.scheduler_decision_proposed, so scheduler/background Decision proposals entering Task Dynamics remain actionable proposal cards instead of narrative-only events.',
