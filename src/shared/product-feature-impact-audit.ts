...
export const PRODUCT_FEATURE_IMPACT_AUDIT: ProductFeatureImpactAuditItem[] = [
  ...
  },
  {
    ...
    evidence: [
      ...
      'Agent API provider tool readiness summaries now expose providerMetadataOwner, providerMetadataPackage, explicitToolDeclarationSource, and declaredToolCount, so settings and smokes can distinguish provider-owned package declarations from runtime-probe-only tool discovery.',
