...
export const PRODUCT_FEATURE_IMPACT_AUDIT: ProductFeatureImpactAuditItem[] = [
  ...
  },
  {
    ...
    evidence: [
      ...
      'Brief completed automatic-sweep chips now include started and blocked counts parsed from lastScheduledEventAgentSweepSummary, so operators can see whether the last sweep started work or hit blocked tasks without opening the tooltip.',
