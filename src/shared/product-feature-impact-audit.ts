...
export const PRODUCT_FEATURE_IMPACT_AUDIT: ProductFeatureImpactAuditItem[] = [
  ...
  },
  {
    ...
    evidence: [
      ...
      'Runtime patch promotion routing now requires expected file evidence to be safe and duplicate-free before patchArtifact can be ready, requires expected and touched file evidence to be duplicate-free before touchedFileEvidenceChain can be ready, and SandboxPatchPromotionApplyService blocks duplicate patch file entries before writing workspace files.',
