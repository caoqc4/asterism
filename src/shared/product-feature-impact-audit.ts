...
export const PRODUCT_FEATURE_IMPACT_AUDIT: ProductFeatureImpactAuditItem[] = [
  ...
  },
  {
    ...
    evidence: [
      ...
      'Brief completed automatic-sweep chips now include checked, started, blocked, and trigger Run evidence labels parsed from lastScheduledEventAgentSweepSummary, so operators can see the last sweep scope, whether it started work or hit blocked tasks, and whether trigger evidence is waiting for terminal Run evidence or ready for review without opening the tooltip.',
