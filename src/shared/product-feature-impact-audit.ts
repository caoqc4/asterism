...
export const PRODUCT_FEATURE_IMPACT_AUDIT: ProductFeatureImpactAuditItem[] = [
  ...
  },
  {
    ...
    evidence: [
      ...
      'AgentAutomationReadiness now returns satisfied and missing requirement lists plus requirements=x/9 and missingRequirements=... summary evidence, so mature scheduled/event tasks can show that only scheduled_event_entrypoint remains missing.',
