...
export const PRODUCT_FEATURE_IMPACT_AUDIT: ProductFeatureImpactAuditItem[] = [
  ...
  },
  {
    ...
    evidence: [
      ...
      'Agent API decomposition promotion readiness now keeps applyPlanSubtaskTitleEvidenceChain missing for empty create-many apply plans, so a zero-subtask draft cannot report title evidence as ready while subtask_create_many_apply_plan is blocked.',
