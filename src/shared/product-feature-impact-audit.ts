...
export const PRODUCT_FEATURE_IMPACT_AUDIT: ProductFeatureImpactAuditItem[] = [
  ...
  },
  {
    ...
    evidence: [
      ...
      'Settings configuration safety rows now render runtime.scheduler evidence chips for proposalReady, proposalRequirements, proposalMissingRequirements, missingRequirements, approvalQueueSurface, authorization, operatorId, standingApprovalPolicyId, standingApprovalScopeTask, standingApprovalActive, standingApprovalScopeMatched, decisionPersistenceAllowed, writebackDispatchAllowed, schedulerTriggerAllowed, runtimeStartRequirements, and runtimeStartMissingRequirements, so operators can inspect scheduler Decision proposal gaps, authorization evidence, and closed persistence/writeback/trigger gates without parsing the full diagnostic summary.',
