...
export const PRODUCT_FEATURE_IMPACT_AUDIT: ProductFeatureImpactAuditItem[] = [
  ...
  },
  {
    ...
    evidence: [
      ...
      'Settings configuration safety rows now render runtime.scheduler evidence chips for proposalReady, approvalQueueSurface, authorization, operatorId, standingApprovalPolicyId, standingApprovalScopeTask, standingApprovalActive, standingApprovalScopeMatched, runtimeStartRequirements, and runtimeStartMissingRequirements, so operators can inspect scheduler Decision proposal authorization evidence without parsing the full diagnostic summary.',
