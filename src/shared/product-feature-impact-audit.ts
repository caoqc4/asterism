...
export const PRODUCT_FEATURE_IMPACT_AUDIT: ProductFeatureImpactAuditItem[] = [
  ...
  },
  {
    ...
    evidence: [
      ...
      'Right-panel Agent API decomposition confirmation now carries the draft evidenceRunId back into the final reversible proposal card during its pre-dispatch promotion-readiness recheck, so proposalEvidenceRunChain remains same-run from draft generation through operator-confirmed child creation.',
