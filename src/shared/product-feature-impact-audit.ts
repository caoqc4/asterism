...
export const PRODUCT_FEATURE_IMPACT_AUDIT: ProductFeatureImpactAuditItem[] = [
  ...
  },
  {
    ...
    evidence: [
      ...
      'Settings configuration safety rows now render sandbox.patch_promotion evidence chips for promotionReady, promotionRequirements, selectedRuntimeContract, targetTaskIdentity, sameRunEvidenceChain, explicitOperatorApply, postApplyRunEvidence, operatorId, patchArtifactId, promotionDecisionId, patchRunId, decisionRunId, preflightRunId, postApplyRunId, sameRunId, touchedFileCount, and touchedFiles so operators can review patch promotion routing identity without parsing the full diagnostic summary.',
