...
export const PRODUCT_FEATURE_IMPACT_AUDIT: ProductFeatureImpactAuditItem[] = [
  ...
  },
  {
    ...
    evidence: [
      ...
      'Agent API decomposition promotion readiness now includes proposal/apply-plan summary and acceptance-criteria evidence chains in the reversible proposal card identity check, so a child-task draft cannot be promoted when only titles match but the operator-visible summary or acceptance criteria diverge from the subtask.create_many apply plan.',
