...
export const PRODUCT_FEATURE_IMPACT_AUDIT: ProductFeatureImpactAuditItem[] = [
  ...
  },
  {
    ...
    evidence: [
      ...
      'Right-panel AI decomposition draft readiness now projects promotionReadiness identity chips for proposalId, parentTask, subtaskCount, evidenceRunId, confirmationBoundary, draftOnlyBeforeConfirmation, runtimeMode, and invocationLayer, so the operator can inspect the reversible proposal boundary before creating child tasks.',
