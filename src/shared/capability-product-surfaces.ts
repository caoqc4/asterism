...
export const PRODUCT_RUNTIME_RULE_ITEMS: ProductRuntimeRuleItem[] = [
  ...
  },
  {
    ...
    desc: '业务记忆规则：Business Records、BusinessLineContextPack、Reviews、SOP、Task.md、Task Records 和恢复信息如何读写。',
    layer: 'Phase-loaded skill',
    load: '读取、写入、刷新、切换或评估业务/任务记忆时加载',
  ...
  },
  {
    ...
    desc: 'Pilot 决策契约：把 GoalPilot 推进判断和业务线注意力排序落成 operation mode、backendPlan、消息优先级、DecisionBackend、执行器、升级和 gate。',
    layer: 'Phase-loaded architecture skill',
    load: '设计、审查或执行 Pilot 判断、steer/follow-up/escalate、executor routing 或业务线/Next Action 协调时加载',
  ...
  },
  {
    ...
    desc: '业务线注意力排序规则：复用 Today/Brief/Pilot why-now 语义，决定当前最该处理的业务线、Next Action、record_gap、improvement、阻塞、拍板或复核。',
    layer: 'Phase-loaded skill',
    load: 'Today、Brief、Pilot 或 legacy task 队列需要选择业务线焦点、Next Action、解释 why now 或升级时加载',
