...
export const PRODUCT_RUNTIME_RULE_ITEMS: ProductRuntimeRuleItem[] = [
  ...
  {
    id: 'pilot.coordinator',
    name: 'Pilot Coordinator',
    invokeId: 'pilot.coordinator',
    desc: 'Pilot 协调者规则：判断消息优先级、任务推进动作、DecisionBackend、执行器选择、升级和多 agent runtime 委派边界。',
    layer: 'Architecture skill',
    load: '设计或执行 Pilot 判断、steer/follow-up/escalate、executor routing 或多任务协调时加载',
