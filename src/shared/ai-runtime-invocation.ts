...
export function evaluateAgentApiExecutionPromotionReadinessFromEvidence(
  ...
  return {
    ...
    summary: [
      ...
      `pilotDecisionBackendPlanBackend=${pilotDecisionBackendPlan?.backend ?? 'missing'}`,
      ...
      `pilotDecisionBackendPlanOutputContract=${pilotDecisionBackendPlan?.outputContract ?? 'missing'}`,
      ...
      `pilotDecisionBackendChoiceEvidence=${pilotDecisionBackendPlan ? 'recorded' : 'missing'}`,
      `pilotDecisionDurableStateMutationAllowed=${pilotDecisionBackendPlan ? 'no' : 'missing'}`,
