...
export const RUNTIME_LIFECYCLE_COVERAGE: RuntimeLifecycleCoverageItem[] = [
  ...
  },
  {
    ...
    gaps: [
      ...
      'External Access now has a structured connector status service, adapter contract, opt-in local inbox adapter, and opt-in Gmail adapter; OAuth token creation/refresh, persistence wiring, and live connector smoke coverage remain future work.',
