...
export const RUNTIME_LIFECYCLE_COVERAGE: RuntimeLifecycleCoverageItem[] = [
  ...
  },
  {
    ...
    gaps: [
      ...
      'External Access now has a structured connector status service, adapter contract, opt-in local inbox adapter, opt-in Gmail adapter, and Gmail OAuth service/IPC/UI token/session/disconnect plumbing; live OAuth smoke coverage and production Google verification remain future work.',
