...
export const RUNTIME_LIFECYCLE_COVERAGE: RuntimeLifecycleCoverageItem[] = [
  ...
  },
  {
    ...
    coveredBy: [
      ...
      'RightPanel context refresh/manual refresh/global conversation reset/leave-task-context are registered as context.refreshOrLeave, while cross-task panel switching is registered as context.taskSwitch; both consume RuntimeHandoff and pending TaskMemoryGuidanceState without claiming task completion or subtask_start.',
