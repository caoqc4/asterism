...
export const RUNTIME_LIFECYCLE_COVERAGE: RuntimeLifecycleCoverageItem[] = [
  ...
  },
  {
    ...
    gaps: [
      ...
      'CodeAgent API-like paths do not yet consume context_readiness; do not mark those paths as readiness-covered until their service boundary records the same verdict.',
