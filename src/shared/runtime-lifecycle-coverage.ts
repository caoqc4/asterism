...
export const RUNTIME_LIFECYCLE_COVERAGE: RuntimeLifecycleCoverageItem[] = [
  ...
  },
  {
    ...
    coveredBy: [
      ...
      'CanonicalDataDiagnostics can mechanically report missing canonical fields, orphan task references, blocker/dependency orphan links, blocker source-context orphan links, and missing task-scoped Decision bindings without mutating records.',
