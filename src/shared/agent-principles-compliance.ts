...
export const AGENT_PRINCIPLES_COMPLIANCE: AgentPrinciplesComplianceItem[] = [
  ...
  },
  {
    ...
    implementedBy: [
      ...
      'Default Gmail, Brainstorming, and Playwright MCP catalogue entries share product-surface definitions, and their pages consume the same CapabilityRegistry and ConfigurationSafetyReport rows instead of page-local capability semantics.',
  ...
  },
  {
    ...
    implementedBy: [
      ...
      'CanonicalDataDiagnostics reports missing canonical fields, hierarchy backlink mismatches, orphan task references, blocker/dependency orphan links, blocker source-context orphan links, and missing task-scoped Decision bindings as read-only diagnostics before any repair flow mutates records.',
    ...
    gaps: [
      ...
      'CanonicalDataDiagnostics covers read-only mechanical checks, and CanonicalDataWriteValidation covers retained task-file, source-context, artifact, Decision, Work Habit, and process-template write boundaries; future repository and service write paths should consume canonical field authority where write-time validation becomes mechanical.',
