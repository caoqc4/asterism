...
export const AGENT_PRINCIPLES_COMPLIANCE: AgentPrinciplesComplianceItem[] = [
  ...
  },
  {
    ...
    priority: 'p0',
    implementedBy: [
      'RuntimeEntrypointCoverage keeps retained entrypoints explicit for provider-visible execution, provider-visible planning, provider-visible assistance, hidden local execution, task capture, ordinary task transitions, running/completion transitions, hierarchy maintenance, project decomposition, decision draft, decision creation, decision action, agent tools, durable writes, product configuration, preference memory, method-library writes, capability probes, context transitions, task dynamics, and capability checks.',
  ...
  },
  {
    ...
    implementedBy: [
      ...
      'RuntimeEntrypointCoverage keeps retained execution, planning, assistance, resume, capability-probe, context-transition, task-capture, ordinary task-transition, running/completion transition, project-decomposition, decision-draft, decision-write, decision-action, agent-tool, product-configuration, preference-memory, method-library, and durable-write entrypoints explicit with required runtime gates.',
