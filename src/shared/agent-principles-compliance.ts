...
export const AGENT_PRINCIPLES_COMPLIANCE: AgentPrinciplesComplianceItem[] = [
  ...
  },
  {
    ...
    gaps: [
      'SubtaskStartEvaluation now guards phase-closeout handoff, completion handoff, direct running transitions, ordinary Run starts, Code Agent starts, and operator-started runs, but some retained task-entry paths still need to pass full parent/handoff/context signals before every subtask start.',
