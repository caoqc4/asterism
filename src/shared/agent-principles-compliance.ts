...
export const AGENT_PRINCIPLES_COMPLIANCE: AgentPrinciplesComplianceItem[] = [
  ...
  },
  {
    ...
    priority: 'p0',
    implementedBy: [
      'RuntimeEntrypointCoverage keeps retained entrypoints explicit for provider-visible execution, provider-visible planning, provider-visible assistance, hidden local execution, task capture, ordinary task transitions, running/completion transitions, completion-check records, hierarchy maintenance, project decomposition, decision draft, decision creation, decision action, agent tools, durable writes, product configuration, preference memory, method-library writes, capability probes, context transitions, task dynamics, and capability checks.',
