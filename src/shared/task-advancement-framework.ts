...
export const TASKPLANE_TASK_ADVANCEMENT_FRAMEWORK_TITLE = 'GoalPilot Business Advancement Framework';
...
export const TASKPLANE_TASK_ADVANCEMENT_FRAMEWORK = [
  ...
  '## Purpose',
  '',
  'GoalPilot is the short, always-loaded business-line advancement layer for',
  'Taskplane and the operating reference for product-side movement decisions. It is',
  'the single always-loaded product rule for business-line advancement.',
  '',
  'It decides how work moves from fuzzy intent to a shaped business line,',
  'executable Next Action, verified result, and recoverable record or learning. A',
  'Business Line is the durable product object. A Task is the execution unit and',
  'Next Action carrier. Legacy task recovery remains supported, but it is not the',
  'default product ownership model.',
  '',
  'GoalPilot does not contain detailed execution, memory, output, source, or tool',
  'rules. Instead, it routes each movement to the smallest needed runtime, rule',
  'document, skill, hook, or review path.',
  '',
  'Use it silently. Do not show GoalPilot as a checklist unless the user asks why a movement was chosen.',
  '',
  '## Core Question',
  '',
  'What is the smallest movement that advances this business line, selected Next',
  'Action, or one-off request without creating unnecessary structure?',
  '',
  ...
  '  and Pilot when business lines or Next Actions compete.',
  ...
  '',
  '- Identify the scope: business line, global inbox, Next Action / task, running',
  '  run, correction, handoff, one-off chat, or legacy task recovery.',
  '- If durable work affects a business, product, content channel, workflow, or',
  '  automation loop and no business line exists, shape or create the business line',
  '  before treating a task as the owner.',
  '- If multiple business lines or Next Actions compete, load Priority Attention',
  '  Routing and select the focus before judging advancement.',
  '- If the user clearly selected the current business line or Next Action, do not',
  '  re-rank the whole pool unless a blocker, risk, or dependency changes the focus.',
  '- For the focus, choose the smallest movement: clarify, research, shape, create',
  '  business line, choose Next Action, execute, verify, review, persist, learn,',
  '  hand off, or pause.',
  '- Load the smallest needed rule, skill, runtime, hook, gate, or review path.',
  '- Choose the executor task only after the movement and permission boundary are',
  '  clear.',
  '- After the movement, stay on this business line, enter a Next Action, return to',
  '  the parent business line, use legacy task recovery, or stop.',
  '',
  ...
  '- Can source review, web research, files, records, task memory, or runtime tools',
  '  answer the uncertainty better than asking the user?',
  '- Is the current context clean, or contaminated by another business line, task,',
  '  stale prompt, unrelated selected file, or previous conversation?',
  '',
  '## Context Readiness',
  '',
  'Before asking or executing, judge whether the context is clean and sufficient.',
  '',
  'Context is sufficient when the business line or one-off scope, Next Action or',
  'movement, risk or permission boundary, and recovery source are clear enough for',
  'a reversible next step. Missing details are not blockers when they are',
  'adjustable defaults or can be learned from files, source review, web research,',
  'records, task memory, runtime tools, or a first-pass draft.',
  '',
  ...
  '- Task Memory Spec: load when reading/writing business or task memory, switching',
  '  focus, clearing context, closing a phase, or deciding if recovery is',
  '  sufficient.',
  ...
  '- Priority Attention Routing: load when Brief or Pilot must rank competing',
  '  business lines, Next Actions, blockers, decisions, dependencies, artifacts, or',
  '  completion chances.',
  ...
  '  criteria, and next step of the execution unit / Next Action.',
  ...
  '- Task.md and Task Records for active Next Action execution memory and legacy',
  '  task recovery.',
  ...
  '',
  'Before compacting, resetting, switching business lines or Next Actions,',
  'advancing a child task, or starting a new conversation, first classify the',
  'current chat: temporary noise, active reasoning, recoverable signal, handoff, or',
  'decision/blocker.',
  '',
  ...
  'Do not carry business line A or task A chat history into business line B or task',
  'B as if it were durable memory.',
  '',
  '## Verification And Review',
  '',
  'Do not treat generated text, a run result, or an obvious next action as proof',
  'that the business line is healthy or the current execution task is complete.',
  '',
