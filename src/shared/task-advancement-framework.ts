...
export const TASKPLANE_TASK_ADVANCEMENT_FRAMEWORK = [
  ...
  '- Native Agent Runtime Orchestration: load when changing CLI/API runtime architecture, Write Intent, DecisionBackend, progress projection, or adapter boundaries.',
