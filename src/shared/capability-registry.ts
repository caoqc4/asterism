...
function agentApiRuntimeCapability(snapshot: RuntimeCapabilitySnapshot | null): CapabilityRegistryEntry {
  ...
  return {
    ...
    summary: [
      ...
      `configuredProviderIsExecutionReady=${providerConfigured ? 'no' : 'missing'}`,
      `providerToolProbeIsTaskExecutionReady=${providerToolReadiness.status === 'declared' ? 'no' : 'not_declared'}`,
      'readOnlyProposalCapable=partial',
      'executionReady=no',
      'promotionScope=per_movement_per_entrypoint',
      ...
      scalarSummaryValue(providerNativeSessionReadiness.summary, 'providerNativeProviderCallIdCount')
        ...
        : null,
      scalarSummaryValue(providerNativeSessionReadiness.summary, 'providerNativeProviderCallIdIdentity')
        ? `providerNativeProviderCallIdIdentity=${scalarSummaryValue(providerNativeSessionReadiness.summary, 'providerNativeProviderCallIdIdentity')}`
        : null,
      ...
      scalarSummaryValue(providerToolReadiness.summary, 'declaredToolCount')
        ...
        : null,
      scalarSummaryValue(providerToolReadiness.summary, 'declaredWebSearchToolCount')
        ? `declaredWebSearchToolCount=${scalarSummaryValue(providerToolReadiness.summary, 'declaredWebSearchToolCount')}`
        : null,
      ...
      scalarSummaryValue(providerToolReadiness.summary, 'trustedWebSearchTools')
        ...
        : null,
      scalarSummaryValue(providerToolReadiness.summary, 'untrustedWebSearchToolCount')
        ? `untrustedWebSearchToolCount=${scalarSummaryValue(providerToolReadiness.summary, 'untrustedWebSearchToolCount')}`
        : null,
      scalarSummaryValue(providerToolReadiness.summary, 'untrustedWebSearchTools')
        ? `untrustedWebSearchTools=${scalarSummaryValue(providerToolReadiness.summary, 'untrustedWebSearchTools')}`
        : null,
      'startupProbe=never',
