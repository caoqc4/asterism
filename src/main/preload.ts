...
const api: ElectronApi = {
  ...
  openAgentCliInstall: (input) => ipcRenderer.invoke('settings:openAgentCliInstall', input),
  ...
  previewExternalAccessSourceIngestion: (input) => ipcRenderer.invoke('externalAccess:sourceIngestionPreview', input),
  commitExternalAccessSourceIngestion: (input) => ipcRenderer.invoke('externalAccess:sourceIngestionCommit', input),
  listTasks: () => ipcRenderer.invoke('task:list'),
  getTaskHierarchyConsistency: () => ipcRenderer.invoke('task:getHierarchyConsistency'),
  getTaskHierarchyManualReviewPolicy: () => ipcRenderer.invoke('task:getHierarchyManualReviewPolicy'),
  applySafeTaskHierarchyRepairs: () => ipcRenderer.invoke('task:applySafeHierarchyRepairs'),
  applyTaskHierarchyManualResolution: (input) => ipcRenderer.invoke('task:applyHierarchyManualResolution', input),
  ...
  listDecisionJudgments: () => ipcRenderer.invoke('decision:listJudgments'),
