...
const api: ElectronApi = {
  ...
  rejectBusinessLineSkillRevision: (input) => ipcRenderer.invoke('businessLine:rejectSkillRevision', input),
  disableBusinessLineSkillRevision: (input) => ipcRenderer.invoke('businessLine:disableSkillRevision', input),
