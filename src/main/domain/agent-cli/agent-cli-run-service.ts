...
function buildTaskplaneWriteIntentPromptInstructions(): string {
  return [
    ...
    'If your result contains durable task memory, a task file draft, task artifact, source evidence, a decision proposal, next-step update, blocker, or completion proposal that Taskplane should offer to save, append at most one fenced JSON block.',
    'Allowed intent types: task_record.create, task_file.propose, artifact.propose, source_context.create, decision.create, task.update_next_step, task.mark_blocked, task.complete.propose.',
    '{"type":"TASKPLANE_WRITE_INTENTS","intents":[{"type":"task_record.create","confidence":"medium","content":"..."},{"type":"task_file.propose","path":"notes.md","content":"...","summary":"..."},{"type":"artifact.propose","title":"artifact.md","content":"...","summary":"..."},{"type":"source_context.create","title":"...","uri":"https://...","note":"...","credibility":"unknown"},{"type":"decision.create","title":"...","rationale":"...","options":["..."],"proposedOutcome":"..."},{"type":"task.update_next_step","nextStep":"...","reason":"..."},{"type":"task.mark_blocked","reason":"...","unblockCondition":"..."},{"type":"task.complete.propose","evidence":"..."}]}',
