...
export const decisionRequests = sqliteTable('decision_requests', {
  ...
  kind: text('kind').notNull().default('direction_choice'),
...
export const sourceContexts = sqliteTable('source_contexts', {
  ...
  sourceRole: text('source_role').notNull().default('raw'),
  credibility: text('credibility'),
  isDuplicate: text('is_duplicate').notNull().default('false'),
  containsSensitiveData: text('contains_sensitive_data').notNull().default('false'),
  createdAt: text('created_at').notNull(),
  updatedAt: text('updated_at').notNull(),
...
export const businessLineSkillRevisions = sqliteTable('business_line_skill_revisions', {
  ...
  approvalSourceId: text('approval_source_id'),
  ...
  reviewAfterAt: text('review_after_at'),
