...
function agentApiDecompositionPromotionEvidenceChips(
  ...
  const summaryKeys = [
    ...
    'proposalSubtaskSummaries',
    'applyPlanSubtaskSummaries',
    'proposalSubtaskSummaryEvidenceChain',
    'applyPlanSubtaskSummaryEvidenceChain',
    'proposalAcceptanceCriteria',
    'applyPlanAcceptanceCriteria',
    'proposalAcceptanceCriteriaEvidenceChain',
    'applyPlanAcceptanceCriteriaEvidenceChain',
    'proposalRationales',
    'applyPlanRationales',
    'proposalRationaleEvidenceChain',
    'applyPlanRationaleEvidenceChain',
    ...
    'runtimeMode',
    'invocationLayer',
    'selectedRuntimeEvidenceRunId',
    'selectedRuntimeEvidenceRunChain',
    'selectedRuntimeParentTask',
    'selectedRuntimeParentTaskEvidenceChain',
    'providerConfigured',
    'configuredProvider',
