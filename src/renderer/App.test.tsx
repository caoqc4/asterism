  ...
  it('surfaces Agent API Runtime shared capability and safety state', async () => {
    ...
    vi.mocked(harness.api.getAiConfigStatus).mockResolvedValue(buildAiStatus({
      ...
      capabilityRegistry: [{
        ...
        requiresApproval: true,
        requiredGate: 'runtime_pre_step',
        summary: 'executionKind=api / status=partial / supportedPhases=chat,decomposition,decision,scheduled_brief / executionRun=deferred / executionRunPromotionReady=no / executionRunPromotionRequirements=0/11 / executionRunMissingRequirements=selected_runtime_contract,target_task_identity,provider_visible_preflight / executionRunPromotionMissingRequirements=selected_runtime_contract,target_task_identity,provider_visible_preflight / executionRunKeyGates=runtime_context_assembly,context_readiness / executionRunMissingGates=runtime_context_assembly,context_readiness / decompositionPromotionRequirements=0/7 / decompositionMissingRequirements=selected_runtime_contract,parent_task_identity,reversible_proposal_card / decompositionPromotionMissingRequirements=selected_runtime_contract,parent_task_identity,reversible_proposal_card / providerToolReadiness=not_declared / providerToolStatus=not_declared / providerToolRequirements=3/5 / providerToolMissingRequirements=provider_owned_metadata,explicit_tool_declaration / selectedApiRuntime=ready / providerConfigured=ready / startupProbe=never / providerOwnedMetadata=missing / providerMetadataOwner=missing / providerMetadataPackage=missing / explicitToolDeclaration=missing / explicitToolDeclarationSource=missing / declaredToolCount=0 / selected=true / provider=configured',
      }],
      configurationSafetyReport: {
        secretExposureSafe: true,
        blockedReasons: [],
        ...
        surfaces: [{
          ...
          reason: 'executionKind=api / status=partial / supportedPhases=chat,decomposition,decision,scheduled_brief / executionRun=deferred / executionRunPromotionReady=no / executionRunPromotionRequirements=0/11 / executionRunMissingRequirements=selected_runtime_contract,target_task_identity,provider_visible_preflight / executionRunPromotionMissingRequirements=selected_runtime_contract,target_task_identity,provider_visible_preflight / executionRunKeyGates=runtime_context_assembly,context_readiness / executionRunMissingGates=runtime_context_assembly,context_readiness / decompositionPromotionRequirements=0/7 / decompositionMissingRequirements=selected_runtime_contract,parent_task_identity,reversible_proposal_card / decompositionPromotionMissingRequirements=selected_runtime_contract,parent_task_identity,reversible_proposal_card / providerToolReadiness=not_declared / providerToolStatus=not_declared / providerToolRequirements=3/5 / providerToolMissingRequirements=provider_owned_metadata,explicit_tool_declaration / selectedApiRuntime=ready / providerConfigured=ready / startupProbe=never / providerOwnedMetadata=missing / providerMetadataOwner=missing / providerMetadataPackage=missing / explicitToolDeclaration=missing / explicitToolDeclarationSource=missing / declaredToolCount=0 / selected=true / provider=configured',
    ...
    expect(within(providerToolReadiness).getByText('providerToolRequirements=3/5')).toBeTruthy();
    expect(within(providerToolReadiness).getByText('providerToolMissingRequirements=provider_owned_metadata,explicit_tool_declaration')).toBeTruthy();
    ...
    expect(within(providerToolReadiness).getByText('providerOwnedMetadata=missing')).toBeTruthy();
    expect(within(providerToolReadiness).getByText('providerMetadataOwner=missing')).toBeTruthy();
    expect(within(providerToolReadiness).getByText('providerMetadataPackage=missing')).toBeTruthy();
    expect(within(providerToolReadiness).getByText('explicitToolDeclaration=missing')).toBeTruthy();
    expect(within(providerToolReadiness).getByText('explicitToolDeclarationSource=missing')).toBeTruthy();
      ...
      configurationSafetyReport: {
        ...
        surfaces: [
          ...
          },
          {
            ...
            diagnosticSummary: 'Scheduled/event trigger plan / status=blocked / triggerPlanReady=no / runtimeStartAllowed=false / runtimeStartReady=no / runtimeStartRequirements=1/3 / runtimeStartMissingRequirements=trigger_plan_ready,run_limit_count / schedulerTriggerServiceConnected=true',
            requiresApproval: true,
            startupProbePolicy: 'never',
            exposesSecretValue: false,
          },
