# Asterism Claude Code Instructions

This file is a thin native Claude Code adapter. It points Claude Code to
asterism's canonical runtime rules without duplicating long specs.

asterism is the product control layer. Native CLIs execute work and return
evidence; asterism owns durable task state, task memory, source context,
