...
- `npm run smoke:timeline-ui:mac` launches the packaged macOS app with isolated user data, seeds a Task detail Timeline fixture in SQLite, and verifies the real packaged renderer shows grouped Timeline preview and expansion behavior
