...
- on 2026-04-27, `npm run verify` passed locally with 119 test files / 827
  ...
  resume-input validation, scheduler checkpoint-state exclusion, and updating
  the local acceptance status.
