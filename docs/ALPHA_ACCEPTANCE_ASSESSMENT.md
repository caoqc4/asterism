...
- `npm run smoke:timeline-ui:mac` launches the packaged macOS app with isolated user data, seeds a Task detail Timeline fixture in SQLite, and verifies the real packaged renderer shows grouped Timeline preview/expansion behavior plus related Timeline grouping on Runs and Decisions
