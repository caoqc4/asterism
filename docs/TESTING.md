...
- `AgentRunLoop`
  typed local observe-then-write plan building, constrained JSON proposal parsing, fallback behavior, visible plan-source run-step writes, and failed / confirmation-needed tool outcomes
- `AgentWorkingContext`
