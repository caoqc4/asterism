...
1. Continue agent execution layer Phase 1 by surfacing run checkpoints in the Runs page and then mapping user-facing confirmations into Decisions where appropriate.
