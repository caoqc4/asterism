...
5. Keep workspace write/command prompt exposure deferred, and evaluate provider capability / structured tool-call design before adding stronger agent execution modes.
