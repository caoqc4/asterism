...
1. Continue agent execution layer Phase 1 by mapping user-facing confirmations into Decisions where appropriate, then add a resume path for approved checkpoints.
