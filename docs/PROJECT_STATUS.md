...
- Completed agent sessions now route task-side recovery copy to terminal
  ...
  replayed.
- Task detail Timeline now groups visible events by date and object family
...
- Applied or already-matched staged patch reviews now take a different Runs
  ...
  unnecessary Code Agent rerun. The packaged Run/Decision recovery smoke now
  covers this path against the macOS app.
