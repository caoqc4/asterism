...
1. Continue the Phase 2 executor/session boundary by surfacing agent session capabilities in run detail before adding workspace, coding, research, or social tools.
