...
1. Continue agent execution layer Phase 1 by deciding whether tool observations should be persisted as dedicated run steps or kept as loop-internal data until the multi-step planner lands.
