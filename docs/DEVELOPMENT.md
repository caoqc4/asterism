...
- Renderer interaction tests cover the main control-plane flows from Home, Tasks, Decisions, Runs, Settings, timeline actions, waiting item flows, artifact flows, home intent-navigation flows, recent-activity follow-up entry flows, task related-activity navigation, and failed Run refresh paths.
