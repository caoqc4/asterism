...
- Service-level tests cover config, task, decision, run, scheduler, and home brief logic, including deeper decision/run-to-task lifecycle annotations, key-source prioritization, plus process-template selection behavior for runs, briefs, and decision drafts.
