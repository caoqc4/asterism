...
- completion-criteria objects as task exit conditions, with task-page creation/edit/satisfy/reopen flows, lightweight completion progress in the task resume card, and task timeline events that help users judge whether a task is actually ready to complete without turning criteria into an enforced checklist engine
