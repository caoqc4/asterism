...
- blocker-aware recovery semantics, including a current blocker object in task detail, blocker-driven recommended actions and resume wording, optional linkage from blockers into source materials, blocker lifecycle timeline events, and blocked-task key signals on the home surface
