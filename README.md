...
- blocker-aware recovery semantics, including a current blocker object in task detail, blocker-driven recommended actions and resume wording, optional linkage from blockers into source materials, and blocker lifecycle timeline events
